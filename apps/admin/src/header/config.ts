...
export const defaultHeaderConfig: HeaderConfig = { branding: { mode: "text", line1: "Eraasim", line2: "Stories & journeys", logoPath: "" }, defaults: { homeVisible: true, blogVisible: true, contactVisible: true, order: ["home", "blog", "contact"] }, manualItems: [], announcement: { visible: false, message: "" } };

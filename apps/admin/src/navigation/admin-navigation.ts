...
export const adminNavigation: readonly AdminNavigationItem[] = [
  ...
  { label: "Analytics", href: "/analytics", permission: "analytics.view" },
  {
    ...
    children: [
      ...
      { label: "Careers", href: "/pages/careers", permission: "pages.careers.view" },
      { label: "All Pages", href: "/pages", permission: "pages.generic.view" },
      { label: "New Page", href: "/pages/new", permission: "pages.generic.create" },
      { label: "Deleted Pages", href: "/pages/deleted", permission: "pages.generic.view" },
    ],
  },
  { label: "Jobs", permission: "jobs.view", children: [
    { label: "All Jobs", href: "/jobs", permission: "jobs.view" },
